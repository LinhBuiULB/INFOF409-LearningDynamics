...
\begin{flalign}
 ...
 - \frac{qD}{2} &< - \frac{V}{2} - T + qT \nonumber \\ 
 \frac{qD}{2} + qT &> \frac{V}{2} + T \nonumber \\ 
...
U_{i}(C,RANDOM) &=  \left[\frac{1}{2} \cdot R + \frac{1}{2} \cdot S \right] \cdot m = (\frac{1}{2} \cdot 3 + \frac{1}{2} \cdot 0) \cdot 10 = 15 \\ \nonumber \\
U_{i}(D,C) &= T \cdot m = 40 \\
U_{i}(D,D) &= P \cdot m = 10 \\
U_{i}(D,TFT) &= T + P \cdot (m-1) = 4 + 9 = 13 \\
U_{i}(D,RANDOM) &= \left[\frac{1}{2} \cdot T + \frac{1}{2} \cdot P \right] = (\frac{1}{2} \cdot 4 + \frac{1}{2} \cdot 1) \cdot 10 = 25 \\ \nonumber \\
U_{i}(TFT,C) &= R \cdot m = 30 \\
U_{i}(TFT,D) &= S + P \cdot (m-1) = 0 + 9 = 9 \\
U_{i}(TFT,TFT) &= R \cdot m = 30 \\
  &\begin{aligned}
    \mathllap{U_{i}(TFT,RANDOM)} &= \left[\frac{1}{2} \cdot R + \frac{1}{2} \cdot S \right]   + \left[\frac{1}{4} \cdot R + \frac{1}{4} \cdot S + \frac{1}{4} \cdot T + \frac{1}{4} + \cdot P \right] \cdot (m-1) \\
      &\qquad = \frac{5}{2} + \left[ 0 + \frac{3}{4} + 1 + \frac{1}{4} \right] \cdot 9 = 19.5 
  \end{aligned}
\end{flalign}

\begin{flalign} 
  U_{i}(RANDOM,C) &= \left[\frac{1}{2} R + \frac{1}{2} \cdot T \right] \cdot m = \left[\frac{1}{2} \cdot 3 + \frac{1}{2} \cdot 4 \right] \cdot 10 = 35 \\
U_{i}(RANDOM,D) &= \left[\frac{1}{2} \cdot S + \frac{1}{2} \cdot P \right] \cdot m = \left[\frac{1}{2} \cdot 0 + \frac{1}{2} \cdot 1 \right] \cdot 10 = 5 \\
 U_{i}(RANDOM,TFT) &= \left[\frac{1}{2} \cdot R + \frac{1}{2} \cdot T \right] + \left[\frac{1}{4} \cdot R + \frac{1}{4} \cdot S + \frac{1}{4} \cdot T + \frac{1}{4} \cdot P \right] \cdot (m-1) \\ 
 &= \frac{7}{2} + \left[ 0 + \frac{3}{4} + 1 + \frac{1}{4} \right] \cdot 9 = 21.5 \nonumber \\
    &\begin{aligned}
    \mathllap{U_{i}(RANDOM,RANDOM)} &= \left[\frac{1}{4} \cdot R + \frac{1}{4} \cdot S + \frac{1}{4} \cdot T + \frac{1}{4} \cdot P \right] \cdot m   \\
